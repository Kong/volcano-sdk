...
description: Control flow patterns for building multi-step agents - parallel execution, conditional branching, loops, sub-agent composition, and multi-LLM workflows.
---
...
:::note[Why use multiple LLMs?]
Different models excel at different tasks. GPT-4 for complex reasoning, Claude for detailed analysis, Mistral for creative writing, local Llama for cost-effective preprocessing. Volcano makes it seamless.
:::
