...
| **Together AI**          | ✅ Full          | ✅ Native                    | ✅ Native | ✅ Complete     |
...
Serverless inference for open-source models (Llama, Mistral, Falcon, etc.) with full OpenAI compatibility.

```typescript
import { llmTogether } from "volcano-sdk";

const together = llmTogether({
...
| Method    | Required     | Description                                               |
| --------- | ------------ | --------------------------------------------------------- |
| `apiKey`  | **Required** | Together API key from api.together.xyz                    |
| `baseURL` | _Optional_   | Custom API endpoint (default: https://api.together.xyz/v1) |

### Configuration

| Parameter | Required     | Description                                            |
| --------- | ------------ | ------------------------------------------------------ |
| `model`   | **Required** | Model identifier (e.g., meta-llama/Llama-3-70b-chat-hf)|
| `apiKey`  | **Required** | Together API key                                       |
| `baseURL` | _Optional_   | Custom API endpoint                                    |
| `options` | _Optional_   | Model-specific parameters                              |
...
| `top_p`              | 0-1                  | Nucleus sampling           |
| `top_k`              | number               | Sample from top K options  |
| `repetition_penalty` | number               | Penalize repetitions       |
| `stop`               | string \| string\[\] | Stop sequences             |
