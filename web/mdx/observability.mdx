---
title: Observability
description: Production-ready observability with OpenTelemetry traces and metrics. Monitor agent performance, debug failures, and optimize costs. Opt-in and fully optional.
---
...
Observability is disabled by default. Enable it by configuring telemetry when creating your agent. No performance impact when disabled.
:::
...
:::tip[That's it!]
Volcano spans and metrics are now being sent to your observability backend. View them in Jaeger, Grafana, DataDog, NewRelic, or any OTEL-compatible system.
:::
...
If `@opentelemetry/api` is not installed, telemetry becomes a no-op. Your code works normally without observability.
:::
